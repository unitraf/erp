...
const Menu = (props) => {
  ...
  return (
    <div className="menu">
      <button ref={menu_toggle_el} className="menu__toggle" style={{width:props.toggle_width&&props.toggle_width}}>
        {props.icon && <Icon
            path={props.icon}
      ...
      <div style={props.content&&props.style} ref={menu_content_el} className="menu_content">
    ...
    {/* {props.view&&props.view} */}
      ...
      <div style={props.view&&props.style} ref={view_content_el} className="view_content"  >
